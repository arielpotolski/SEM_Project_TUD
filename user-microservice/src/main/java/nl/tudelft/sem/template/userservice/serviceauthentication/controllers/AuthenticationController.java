package nl.tudelft.sem.template.userservice.serviceauthentication.controllers;

import nl.tudelft.sem.template.userservice.serviceauthentication.authentication.JwtTokenGenerator;
import nl.tudelft.sem.template.userservice.serviceauthentication.authentication.JwtUserDetailsService;
import nl.tudelft.sem.template.userservice.serviceauthentication.domain.user.NetId;
import nl.tudelft.sem.template.userservice.serviceauthentication.domain.user.Password;
import nl.tudelft.sem.template.userservice.serviceauthentication.domain.user.RegistrationService;
import nl.tudelft.sem.template.userservice.serviceauthentication.models.AuthenticationResponseModel;
import nl.tudelft.sem.template.userservice.serviceauthentication.models.AuthenticationRequestModel;
import nl.tudelft.sem.template.userservice.serviceauthentication.models.RegistrationRequestModel;
