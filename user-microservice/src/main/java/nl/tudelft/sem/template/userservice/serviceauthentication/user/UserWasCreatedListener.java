package nl.tudelft.sem.template.userservice.serviceauthentication.user;

import nl.tudelft.sem.template.userservice.serviceauthentication.domain.user.UserWasCreatedEvent;
